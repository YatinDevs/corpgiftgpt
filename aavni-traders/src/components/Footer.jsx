  ...
  return (
    <>
      <motion.footer
        ...
        className="bg-[#a30d14] text-[#D3D2D2] pt-16 pb-8 px-6 md:px-16"
      >
          ...
          >
            <div className="flex items-center mb-4">
              <img
                ...
                className="h-10 mr-2"
              />
              <h2 className="text-xl font-bold text-[#DEAF29]">
                Aavni Traders
              </h2>
            </div>
      ...
      <motion.div
        ...
        className="flex justify-center items-center text-center text-sm bg-[#fcce01] text-[#D3D2D2]/60 border-t border-[#2F263B] "
      >
        <motion.div className="relative flex">
          {/* Gray curved section */}
          <div
            className={`relative    bg-[#fcce01] text-[#1b53a5] text-sm transition-all duration-300 ${"h-14"}`}
          >
          ...
          <div
            className={`relative z-10 w-1/2 rounded-tl-full bg-[#a30d14] text-white text-sm transition-all duration-300 ${"h-14 "} `}
          >
